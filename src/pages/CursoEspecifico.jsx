...
const curso = {
  ...
  descricao:
    "Aprenda do zero tudo que você precisa saber para construir e dominar as tecnologias mais avançadas do mundo.",
  ...
  modulos: [
    ...
    },
    {
      ...
      aulas: [
        {
          id: 4,
          titulo: "Conceitos básicos de propulsão",
          duracao: "15:45",
          gratis: false,
        },
        {
    ...
    },
    {
      ...
      aulas: [
        {
          id: 7,
          titulo: "Montagem da estrutura principal",
          duracao: "25:15",
          gratis: false,
        },
        {
          id: 8,
          titulo: "Sistema de estabilização",
          duracao: "18:40",
          gratis: false,
        },
        {
          id: 9,
          titulo: "Testes e ajustes finais",
          duracao: "22:00",
          gratis: false,
        },
      ],
    ...
    >
      ...
      <section
        style={{
          ...
          backgroundImage:
            "url('https://images.unsplash.com/photo-1446776811953-b23d57bd21aa?w=1600&auto=format&fit=crop')",
      ...
      >
        <div
          style={{
            ...
            inset: 0,
            background:
              "linear-gradient(90deg, rgba(10,15,40,0.92) 45%, rgba(10,15,40,0.55) 100%)",
          }}
        />
        ...
        >
          ...
          >
            <div
              style={{
                height: "150px",
                background: "linear-gradient(135deg, #1a2e5a 0%, #3b6fd4 100%)",
                display: "flex",
                alignItems: "center",
      ...
      <ul style={{ listStyle: "none", margin: 0, padding: 0 }}>
        {modulo.aulas.map((aula) => (
          ...
          >
            ...
            <span style={{ flex: 1, fontSize: "0.875rem", color: "#334155" }}>
              {aula.titulo}
            </span>
            {aula.gratis && (
              <span
